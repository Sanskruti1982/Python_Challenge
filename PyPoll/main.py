...
print("---------------------------")
print("Khan: " + str(round(percent,0)) + "%  " + "(" + str(count) + ")")
print("Correy: " + str(round(percent1,0)) + "%  " + "(" + str(count1) + ")")
print("Li: " + str(round(percent2,0)) + "%  " + "(" + str(count2) + ")")
print("O'Tooley: " + str(round(percent3,0) + "%  " + "(" + str(count3) + ")")
print("---------------------------")
print("Winner: " + winner)
print("---------------------------")
...
with open(output_file, "w") as datafile:
    ...
    print("---------------------------", file=datafile)
    print("Khan: " + str(round(percent,0)) + "%  " + "(" + str(count) + ")", file=datafile)
    print("Correy: " + str(round(percent1,0)) + "%  " + "(" + str(count1) + ")", file=datafile)
    print("Li: " + str(round(percent2,0)) + "%  " + "(" + str(count2) + ")", file=datafile)
    print("O'Tooley: " + str(round(percent3,0)) + "%  " + "(" + str(count3) + ")", file=datafile)
    print("---------------------------", file=datafile)
